...
namespace Obligatorio.DTOs.Mappers
{
    public class MapperSeguimiento
    {
        ...
        {
            SeguimientoDTO dto = new SeguimientoDTO(seguimiento.Funcionario.NombreCompleto.Nombre + " " + seguimiento.Funcionario.NombreCompleto.Nombre, seguimiento.Comentario, seguimiento.Fecha);
            return dto;
        }
